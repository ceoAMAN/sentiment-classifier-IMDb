...
from modals import RNNModel, LSTMModel
...
if model_choice == "RNN":
    model = RNNModel(vocab_size=len(vocab), embed_dim=embed_dim, hidden_dim=hidden_dim, output_dim=output_dim, num_layers=num_layers).to(device)
else:
    model = LSTMModel(vocab_size=len(vocab), embed_dim=embed_dim, hidden_dim=hidden_dim, output_dim=output_dim, num_layers=num_layers).to(device)
